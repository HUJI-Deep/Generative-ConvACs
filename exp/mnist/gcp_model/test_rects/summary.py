...
def summary(table):
    ...
    accuracies = table.select(['hyper__rect_width', 'hyper__num_rects','test_results0_0_accuracy'])
    accuracies = accuracies.rename({'test_results0_0_accuracy': 'accuracy', 'hyper__rect_width': 'Width', 'hyper__num_rects': 'Number of Rectangles'})
