...
# Trained NICE model location. To train it, follow instructions at 
# https://github.com/HUJI-Deep/nice
model_path = 'path/to/trained/model.pkl'
nice_repo_path = 'path/to/nice/repo'




inpainting_script = os.path.abspath(os.path.join(SCRIPT_DIR, nice_repo_path,
                                                 'pylearn2','scripts','mnist_inpainting.py'))
...
def inpaint_dataset(model_path, missing_data_path):
    ...
    cmd = [inpainting_script, model_norm_path, missing_data_norm_path]
    cmd = ' '.join(cmd)
    print cmd
